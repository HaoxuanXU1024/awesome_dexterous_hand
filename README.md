...
- 2026-08-03 - MANGO-Grasp: Mahalanobis Fields over Geometry-Oriented 3D Gaussians for Cross-Embodiment Dexterous Grasping ([PDF](https://arxiv.org/pdf/2608.02014)) - Uses geometry-oriented Gaussian primitives and morpho-kinematic hand descriptors to optimize one zero-shot grasp formulation across embodiments.
